...
Your loop is only as good as its measurement. A bad verify command produces noise; a good one produces signal. These are battle-tested commands — copy-paste into your config and adjust paths.
