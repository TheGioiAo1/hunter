...
The lab notebook. Every iteration gets one line — no exceptions, no "I'll log it later." The TSV file is the single source of truth for what was tried, what worked, and when the loop hit a wall.
