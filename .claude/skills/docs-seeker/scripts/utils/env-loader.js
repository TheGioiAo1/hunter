 ...
 * Priority (low → high):
 *   .claude/.env < .claude/skills/.env < .claude/skills/<skill>/.env < process.env
 */
 ...
 */
function loadEnv() {
  const skillDir = path.resolve(__dirname, '../..');   // .claude/skills/docs-seeker
  const skillsDir = path.resolve(skillDir, '..');      // .claude/skills
  const claudeDir = path.resolve(skillsDir, '..');     // .claude
